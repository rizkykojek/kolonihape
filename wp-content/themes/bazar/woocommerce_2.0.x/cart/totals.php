            ...
            <?php if ( ! $woocommerce->shipping->enabled || $available_methods || ! $woocommerce->customer->get_shipping_country() || ! $woocommerce->customer->has_calculated_shipping() ) : ?>
                ...
                <table align="right" cellspacing="0" cellpadding="0">
                    ...
                    <?php if ($woocommerce->cart->get_discounts_before_tax()) : ?>
                        ...
                        <tr class="discount">
                            <th><?php _e('Cart Discount', 'yit'); ?> <a href="<?php echo esc_url( add_query_arg('remove_discounts', '1', $woocommerce->cart->get_cart_url()) ) ?>"><?php _e('[Remove]', 'yit'); ?></a></th>
                    ...
                    <?php if ( $woocommerce->cart->get_discounts_after_tax() ) : ?>
                        ...
                        <tr class="discount">
                            <th><?php _e( 'Order Discount', 'yit' ); ?> <a href="<?php echo esc_url( add_query_arg( 'remove_discounts', '2', $woocommerce->cart->get_cart_url() ) ) ?>"><?php _e( '[Remove]', 'yit' ); ?></a></th>
